...
function miniChallenge() {
	...
	if (rupaulm == true) {
		...
		miniChallengeScreen.createButton("Conjoined Queens", "queensConjoined()");
	}
}
//GENERAL CHALLENGES:
let team1 = [];
...
//QUEENS:
//SEASON 1: 
let akashia = new Queen("Akashia", 3, 2, 7, 3, 2, 7, 1, "true", "Akashia");
let bebe = new Queen("BeBe Zahara Benet", 6, 7, 8, 12, 6, 10, 9, "true", "BeBe");
let jade = new Queen("Jade Sotomayor", 3, 3, 8, 7, 3, 7, 7, "true", "Jade");
let ninaf = new Queen("Nina Flowers", 7, 5, 5, 11, 6, 10, 6, "true", "NinaFlowers");
let ongina = new Queen("Ongina", 9, 8, 7, 9, 10, 9, 8, "true", "Ongina");
let rebecca = new Queen("Rebecca Glasscock", 3, 3, 6, 4, 2, 6, 5, "true", "Rebecca");
let shannel = new Queen("Shannel", 5, 5, 5, 9, 4, 11, 7, "true", "Shannel");
let tammie = new Queen("Tammie Brown", 6, 7, 5, 7, 6, 7, 6, "true", "Tammie");
let victoria = new Queen("Victoria 'Porkchop' Parker", 3, 6, 4, 3, 6, 5, 4, "true", "Victoria");
...
let jessica = new Queen("Jessica Wild", 8, 6, 9, 7, 8, 8, 10, "true", "Jessica");
let jujubee = new Queen("Jujubee", 9, 11, 7, 8, 12, 6, 12, "true", "Jujubee");
let morgan = new Queen("Morgan McMichaels", 6, 6, 10, 9, 5, 10, 10, "true", "Morgan");
let mystique = new Queen("Mystique Summers Madison", 4, 5, 3, 3, 3, 5, 6, "true", "Mystique");
let nicole = new Queen("Nicole Paige Brooks", 4, 4, 4, 6, 4, 7, 6, "true", "Nicole");
let pandora = new Queen("Pandora Boxx", 12, 11, 6, 8, 10, 8, 7, "true", "Pandora");
let raven = new Queen("Raven", 5, 8, 9, 10, 5, 8, 1, "true", "Raven");
let sahara = new Queen("Sahara Davenport", 6, 6, 10, 4, 6, 7, 10, "true", "Sahara");
let shangela = new Queen("Shangela", 14, 13, 10, 3, 9, 9, 12, "true", "Shangela");
let sonique = new Queen("Kylie Sonique Love", 11, 9, 10, 9, 8, 11, 1, "true", "Kylie");
let tatianna = new Queen("Tatianna", 8, 11, 8, 8, 10, 8, 10, "true", "Tatianna");
let tyra = new Queen("Tyra Sanchez", 11, 7, 8, 11, 8, 9, 10, "true", "Tyra");
let us_season2 = [jessica, jujubee, morgan, mystique, nicole, pandora, raven, sahara, shangela, sonique, tatianna, tyra];
//SEASON 3:
let alexis = new Queen("Alexis Mateo", 14, 12, 9, 7, 10, 8, 12, "true", "Alexis");
let carmen = new Queen("Carmen Carrera", 3, 8, 6, 4, 3, 7, 7, "true", "Carmen");
let delta = new Queen("Delta Work", 4, 6, 5, 5, 5, 7, 7, "true", "Delta");
let india = new Queen("India Ferrah", 6, 4, 8, 6, 3, 10, 9, "true", "India");
let manila = new Queen("Manila Luzon", 12, 11, 7, 14, 10, 13, 1, "true", "Manila");
let mariah = new Queen("Mariah Paris Balenciaga", 6, 4, 7, 8, 4, 9, 8, "true", "Mariah");
let mimi = new Queen("Mimi Imfurst", 11, 6, 6, 10, 7, 8, 6, "true", "Mimi");
let phoenix = new Queen("Phoenix", 3, 3, 6, 5, 3, 5, 4, "true", "Phoenix");
let raja = new Queen("Raja", 9, 11, 7, 14, 10, 10, 10, "true", "Raja");
let stacey = new Queen("Stacy Layne Matthews", 6, 7, 5, 4, 10, 5, 6, "true", "Stacy");
let venus = new Queen("Venus D-Lite", 4, 5, 8, 2, 3, 5, 2, "true", "Venus");
let yara = new Queen("Yara Sofia", 11, 9, 9, 13, 7, 10, 8, "true", "Yara");
let us_season3 = [alexis, carmen, delta, india, manila, mariah, mimi, phoenix, raja, shangela, stacey, venus, yara];
//SEASON 4:
let alisa = new Queen("Alisa Summers", 4, 4, 5, 2, 3, 5, 4, "true", "Alisa");
let chad = new Queen("Chad Michaels", 11, 10, 8, 9, 12, 10, 8, "true", "Chad");
let dida = new Queen("Dida Ritz", 8, 7, 8, 5, 7, 7, 12, "true", "Dida");
let jiggly = new Queen("Jiggly Caliente", 4, 6, 9, 4, 4, 7, 10, "true", "Jiggly");
let kenya = new Queen("Kenya Michaels", 9, 6, 6, 6, 8, 7, 8, "true", "Kenya");
let leshauwn = new Queen("Lashauwn Beyond", 4, 4, 6, 11, 5, 7, 7, "true", "Lashauwn");
let latrice = new Queen("Latrice Royale", 11, 8, 9, 8, 7, 9, 13, "true", "Latrice");
let madame = new Queen("Madame LaQueer", 4, 7, 6, 5, 9, 7, 6, "true", "Madame");
let milan = new Queen("Milan", 4, 5, 9, 7, 5, 8, 10, "true", "Milan");
let phiphi = new Queen("Phi Phi O'Hara", 13, 9, 8, 10, 10, 10, 8, "true", "PhiPhi");
let princess = new Queen("The Princess", 4, 4, 5, 7, 4, 7, 7, "true", "Princess");
let willam = new Queen("Willam", 10, 8, 7, 10, 10, 9, 8, "true", "Willam");
...
let alaska = new Queen("Alaska", 15, 14, 7, 8, 14, 10, 1, "true", "Alaska");
let alyssa = new Queen("Alyssa Edwards", 4, 6, 15, 6, 10, 9, 12, "true", "Alyssa");
let coco = new Queen("Coco Montrese", 10, 10, 11, 9, 7, 9, 15, "true", "Coco");
let detox = new Queen("Detox", 10, 9, 9, 9, 8, 12, 1, "true", "Detox");
let honey = new Queen("Honey Mahogany", 10, 3, 3, 6, 6, 8, 4, "true", "Honey");
let ivy = new Queen("Ivy Winters", 11, 4, 8, 12, 7, 10, 7, "true", "Ivy");
let jadejolie = new Queen("Jade Jolie", 5, 7, 8, 7, 8, 7, 8, "true", "JadeJ");
let jinkx = new Queen("Jinkx Monsoon", 15, 14, 9, 8, 15, 8, 8, "true", "Jinkx");
let lineysha = new Queen("Lineysha Sparx", 10, 4, 7, 11, 5, 9, 8, "true", "Lineysha");
let monica = new Queen("Monica Beverly Hillz", 4, 4, 6, 6, 3, 8, 8, "true", "Monica");
let penny = new Queen("Penny Tration", 4, 5, 4, 5, 5, 5, 4, "true", "Penny");
let roxxxy = new Queen("Roxxxy Andrews", 7, 4, 7, 11, 8, 10, 12, "true", "Roxxxy");
let serena = new Queen("Serena ChaCha", 3, 3, 7, 4, 5, 5, 8, "true", "Serena");
let vivienne = new Queen("Vivienne Pinay", 7, 3, 4, 5, 3, 6, 4, "true", "Vivienne");
let us_season5 = [alaska, alyssa, coco, detox, honey, ivy, jadejolie, jinkx, lineysha, monica, penny, roxxxy, serena, vivienne];
//SEASON 6:
let adore = new Queen("Adore Delano", 9, 11, 9, 6, 9, 8, 11, "true", "Adore");
let april = new Queen("April Carrión", 5, 5, 6, 9, 5, 9, 8, "true", "April");
let bendelacreme = new Queen("BenDeLaCreme", 12, 12, 11, 10, 15, 10, 9, "true", "Bendelacreme");
let bianca = new Queen("Bianca Del Rio", 11, 15, 7, 13, 15, 10, 5, "true", "Bianca");
let courtney = new Queen("Courtney Act", 11, 8, 10, 10, 10, 12, 9, "true", "Courtney");
let darienne = new Queen("Darienne Lake", 11, 8, 7, 4, 9, 8, 13, "true", "Darienne");
let gia = new Queen("Gia Gunn", 10, 4, 8, 8, 4, 8, 9, "true", "Gia");
let joslyn = new Queen("Joslyn Fox", 6, 7, 8, 6, 8, 8, 11, "true", "Joslyn");
let kelly = new Queen("Kelly Mantle", 6, 6, 5, 5, 4, 7, 4, "true", "Kellu");
let laganja = new Queen("Laganja Estranja", 9, 5, 14, 8, 6, 10, 15, "true", "Laganja");
let magnolia = new Queen("Magnolia Crawford", 4, 5, 6, 4, 5, 7, 4, "true", "Magnolia");
let milk = new Queen("Milk", 6, 6, 7, 8, 8, 7, 7, "true", "Milk");
let trinityk = new Queen("Trinity K. Bonet", 9, 9, 13, 12, 4, 10, 15, "true", "TrinityKB");
let vivacious = new Queen("Vivacious", 4, 5, 5, 4, 4, 7, 7, "true", "Vivacious");
...
//SEASON 7: 
let ginger = new Queen("Ginger Minj", 14, 12, 8, 9, 15, 7, 12, "true", "Ginger");
let jaidynn = new Queen("Jaidynn Diore Fierce", 9, 7, 8, 6, 6, 7, 11, "true", "Jaidynn");
let jasmine = new Queen("Jasmine Masters", 3, 4, 6, 5, 2, 7, 6, "true", "Jasmine");
let kandy = new Queen("Kandy Ho", 4, 4, 7, 5, 4, 7, 9, "true", "KandyH");
let katya = new Queen("Katya", 9, 12, 9, 7, 12, 10, 9, "true", "Katya");
let kennedy = new Queen("Kennedy Davenport", 9, 8, 10, 8, 11, 10, 14, "true", "Kennedy");
let max = new Queen("Max", 10, 7, 5, 8, 4, 8, 5, "true", "Max");
let fame = new Queen("Miss Fame", 8, 4, 5, 11, 3, 10, 5, "true", "MissFame");
let kasha = new Queen("Mrs. Kasha Davis", 11, 8, 9, 8, 6, 8, 7, "true", "Kasha");
let pearl = new Queen("Pearl", 7, 10, 8, 9, 10, 9, 5, "true", "Pearl");
let sashab = new Queen("Sasha Belle", 6, 6, 4, 4, 6, 6, 4, "true", "SashaB");
let tempest = new Queen("Tempest DuJour", 6, 6, 5, 3, 6, 7, 4, "true", "Tempest");
let trixie = new Queen("Trixie Mattel", 13, 10, 6, 10, 11, 10, 5, "true", "Trixie");
let violet = new Queen("Violet Chachki", 6, 7, 8, 15, 8, 13, 8, "true", "Violet");
...
let acid = new Queen("Acid Betty", 9, 4, 7, 10, 5, 11, 7, "true", "Acid");
let bob = new Queen("Bob The Drag Queen", 15, 15, 8, 9, 15, 8, 12, "true", "Bob");
let chichi = new Queen("Chi Chi DeVayne", 8, 4, 13, 8, 6, 8, 13, "true", "ChiChi");
let cynthia = new Queen("Cynthia Lee Fontaine", 4, 4, 7, 6, 4, 7, 6, "true", "Cynthia");
let dax = new Queen("Dax ExclamationPoint", 5, 6, 6, 5, 6, 5, 4, "true", "Dax");
let derrick = new Queen("Derrick Barry", 7, 7, 8, 8, 9, 7, 8, "true", "Derrick");
let kim = new Queen("Kim Chi", 10, 7, 4, 15, 8, 13, 4, "true", "Kim");
let laila = new Queen("Laila McQueen", 6, 6, 4, 7, 6, 8, 7, "true", "Laila");
let naomi = new Queen("Naomi Smalls", 9, 7, 10, 14, 10, 12, 11, "true", "Naomi");
let naysha = new Queen("Naysha Lopez", 6, 4, 4, 4, 3, 6, 7, "true", "Naysga");
let robbie = new Queen("Robbie Turner", 4, 5, 6, 4, 3, 6, 6, "true", "Robbie");
let thorgy = new Queen("Thorgy Thor", 14, 9, 6, 9, 13, 9, 8, "true", "Thorgy");
...
//SEASON 9: 
let aja = new Queen("Aja", 4, 8, 12, 11, 9, 10, 11, "true", "Aja");
let alexism = new Queen("Alexis Michelle", 8, 7, 9, 7, 13, 6, 9, "true", "AlexisM");
let charlie = new Queen("Charlie Hides", 10, 6, 5, 7, 4, 9, 2, "true", "Charlie");
let eureka = new Queen("Eureka!", 9, 11, 8, 10, 13, 10, 12, "true", "Eureka");
let farrah = new Queen("Farrah Moan", 9, 4, 7, 3, 6, 8, 7, "true", "Farrah");
let jaymes = new Queen("Jaymes Mansfield", 6, 6, 3, 6, 5, 7, 6, "true", "Jaymes");
let kimora = new Queen("Kimora Blac", 5, 5, 4, 6, 5, 8, 7, "true", "Kimora");
let ninab = new Queen("Nina Bo'Nina Brown", 4, 8, 10, 9, 10, 10, 11, "true", "NinaBB");
let peppermint = new Queen("Peppermint", 11, 9, 10, 9, 4, 7, 13, "true", "Peppermint");
let sasha = new Queen("Sasha Velour", 9, 10, 8, 10, 11, 13, 11, "true", "Sasha");
let shea = new Queen("Shea Couleé", 12, 12, 14, 12, 13, 12, 13, "true", "Shea");
let trinity = new Queen("Trinity The Tuck", 13, 10, 8, 10, 8, 9, 12, "true", "TrinityTT");
let valentina = new Queen("Valentina", 11, 7, 10, 9, 9, 9, 9, "true", "Valentina");
...
//SEASON 10: 
let aquaria = new Queen("Aquaria", 6, 11, 8, 15, 12, 14, 11, "true", "Aquaria");
let asia = new Queen("Asia O'Hara", 11, 9, 6, 6, 7, 9, 9, "true", "Asia");
let blair = new Queen("Blair St. Clair", 9, 8, 6, 10, 8, 8, 7, "true", "Blair");
let dusty = new Queen("Dusty Ray Bottoms", 8, 8, 6, 7, 6, 7, 6, "true", "Dusty");
let kalorie = new Queen("Kalorie K. Williams", 6, 6, 6, 5, 7, 7, 8, "true", "Kalorie");
let kameron = new Queen("Kameron Michaels", 5, 8, 14, 10, 8, 8, 15, "true", "Kameron");
let mayhem = new Queen("Mayhem Miller", 4, 8, 9, 13, 7, 9, 9, "true", "Mayhem");
let miz = new Queen("Miz Cracker", 13, 11, 5, 12, 15, 9, 8, "true", "Miz");
let monet = new Queen("Monét X Change", 9, 11, 13, 6, 10, 9, 14, "true", "Monet");
let monique = new Queen("Mo Heart", 12, 9, 8, 11, 15, 13, 9, "true", "Monique");
let vanessa = new Queen("Vanessa 'Vanjie' Mateo", 9, 6, 8, 6, 9, 7, 11, "true", "Vanjie");
let vixen = new Queen("The Vixen", 5, 4, 12, 9, 3, 8, 12, "true", "Vixen");
let yuhua = new Queen("Yuhua Hamasaki", 4, 4, 6, 9, 6, 7, 7, "true", "Yuhua");
...
let akeria = new Queen("A'keria C. Davenport", 11, 9, 11, 8, 10, 13, 9, "true", "Akeria");
let ariel = new Queen("Ariel Versace", 8, 6, 8, 5, 8, 8, 8, "true", "Ariel");
let brooke = new Queen("Brooke Lynn Hytes", 8, 8, 13, 12, 8, 10, 13, "true", "Brooke");
let honeyd = new Queen("Honey Davenport", 4, 6, 5, 7, 4, 9, 4, "true", "HoneyD");
let kahanna = new Queen("Kahanna Montrese", 4, 5, 5, 4, 5, 6, 8, "true", "Kahanna");
let mercedes = new Queen("Mercedes Iman Diamond", 4, 6, 4, 6, 6, 8, 8, "true", "Mercedes");
let ninaw = new Queen("Nina West", 12, 11, 6, 8, 11, 8, 6, "true", "NinaW");
let plastique = new Queen("Plastique Tiara", 10, 7, 8, 11, 8, 10, 9, "true", "Plastique");
let rajah = new Queen("Ra'Jah O'Hara", 6, 8, 11, 13, 8, 11, 13, "true", "Rajah");
let scarlet = new Queen("Scarlet Envy", 13, 7, 6, 13, 8, 10, 7, "true", "Scarlet");
let shuga = new Queen("Shuga Cain", 10, 9, 7, 6, 7, 10, 7, "true", "Shuga");
let silky = new Queen("Silky Nutmeg Ganache", 10, 8, 9, 6, 10, 8, 11, "true", "Silky");
let yvie = new Queen("Yvie Oddly", 12, 4, 12, 11, 6, 10, 15, "true", "Yvie");
let us_season11 = [akeria, ariel, brooke, honeyd, kahanna, mercedes, ninaw, plastique, rajah, scarlet, shuga, silky, vanessa, yvie];
//SEASON 12: 
let aiden = new Queen("Aiden Zhane", 9, 3, 6, 4, 3, 6, 6, "true", "Aiden");
let brita = new Queen("Brita", 7, 8, 7, 4, 6, 8, 11, "true", "Brita");
let crystal = new Queen("Crystal Methyd", 6, 8, 8, 9, 8, 12, 6, "true", "CrystalM");
let dahlia = new Queen("Dahlia Sin", 4, 4, 6, 5, 5, 10, 4, "true", "Dahlia");
let gigi = new Queen("Gigi Goode", 10, 11, 11, 13, 9, 12, 8, "true", "Gigi");
let heidi = new Queen("Heidi N Closet", 6, 9, 11, 6, 12, 7, 13, "true", "Heidi");
let jackie = new Queen("Jackie Cox", 11, 12, 6, 6, 13, 9, 11, "true", "Jackie");
let jaida = new Queen("Jaida Essence Hall", 4, 7, 10, 13, 8, 10, 12, "true", "Jaida");
let jan = new Queen("Jan", 8, 4, 12, 9, 5, 10, 9, "true", "Jan");
let nicky = new Queen("Nicky Doll", 4, 4, 5, 12, 3, 11, 5, "true", "Nicky");
let rock = new Queen("Rock M. Sakura", 6, 6, 6, 4, 8, 8, 7, "true", "Rock");
...
//SEASON 13
let denali = new Queen("Denali", 4, 8, 14, 9, 10, 11, 13, "true", "Denali");
let mik = new Queen("Gottmik", 8, 11, 6, 13, 12, 13, 6, "true", "Gottmik");
let joey = new Queen("Joey Jay", 6, 7, 6, 5, 5, 7, 7, "true", "Joey");
let kahmora = new Queen("Kahmora Hall", 3, 4, 3, 5, 4, 12, 4, "true", "Kahmora");
let kandym = new Queen("Kandy Muse", 9, 10, 5, 6, 7, 8, 14, "true", "KandyM");
let lala = new Queen("LaLa Ri", 5, 7, 10, 2, 6, 9, 14, "true", "Lala");
let olivia = new Queen("Olivia Lux", 11, 5, 11, 10, 8, 11, 8, "true", "Olivia");
let rose = new Queen("Rosé", 12, 11, 13, 8, 10, 10, 6, "true", "Rose");
let symone = new Queen("Symone", 14, 7, 7, 9, 12, 9, 13, "true", "Symone");
let tamisha = new Queen("Tamisha Iman", 7, 6, 7, 5, 6, 7, 7, "true", "Tamisha");
let tina = new Queen("Tina Burner", 6, 6, 10, 5, 6, 8, 9, "true", "TinaB");
let utica = new Queen("Utica Queen", 7, 4, 6, 15, 5, 12, 11, "true", "Utica");
...
let alyssaH = new Queen("Alyssa Hunter", 5, 6, 7, 10, 7, 13, 8, "true", "AlyssaH");
let angeria = new Queen("Angeria Paris VanMicheals", 11, 6, 9, 12, 8, 11, 8, "true", "Angeria");
let bosco = new Queen("Bosco", 11, 12, 6, 7, 12, 11, 6, "true", "Bosco");
let daya = new Queen("Daya Betty", 9, 8, 9, 9, 10, 10, 8, "true", "DayaBetty");
let deja = new Queen("DeJa Skye", 9, 7, 9, 8, 13, 8, 8, "true", "DeJa");
let jasmineK = new Queen("Jasmine Kennedie", 7, 6, 13, 7, 6, 10, 14, "true", "JasmineK");
let jorgeous = new Queen("Jorgeous", 5, 5, 13, 10, 5, 10, 15, "true", "Jorgeous");
let june = new Queen("June Jambalaya", 5, 6, 6, 4, 5, 6, 6, "true", "June");
let kerri = new Queen("Kerri Colby", 6, 6, 5, 5, 6, 9, 6, "true", "Kerri");
let kornbread = new Queen("Kornbread Jeté", 6, 7, 6, 6, 7, 8, 7, "true", "Kornbread");
let cadmen = new Queen("Lady Camden", 12, 11, 12, 11, 7, 10, 11, "true", "LadyCamden");
let maddy = new Queen("Maddy Morphosis", 8, 7, 6, 5, 6, 9, 7, "true", "Maddy");
let orion = new Queen("Orion Story", 4, 6, 6, 5, 6, 6, 5, "true", "Orion");
let willow = new Queen("Willow Pill", 11, 8, 7, 10, 10, 12, 8, "true", "Willow");
let us_season14 = [alyssaH, angeria, bosco, daya, deja, jasmineK, jorgeous, june, kerri, kornbread, cadmen, maddy, orion, willow];
//DRUK SEASON 1 
let baga = new Queen("Baga Chipz", 13, 12, 5, 5, 13, 8, 7, "true", "Baga");
let blu = new Queen("Blu Hydrangea", 5, 9, 8, 10, 10, 12, 9, "true", "Blu");
let cheryl = new Queen("Cheryl Hole", 5, 5, 9, 5, 7, 7, 9, "true", "Cheryl");
let crystaluk = new Queen("Crystal", 6, 5, 6, 9, 4, 8, 6, "true", "Crystal");
let divina = new Queen("Divina De Campo", 11, 6, 9, 12, 9, 9, 9, "true", "Divina");
let gothy = new Queen("Gothy Kendoll", 4, 5, 4, 3, 5, 6, 4, "true", "Gothy");
let scaredy = new Queen("Scaredy Kat", 3, 5, 6, 4, 4, 7, 4, "true", "Scaredy");
let sumting = new Queen("Sum Ting Wong", 8, 6, 6, 7, 6, 9, 8, "true", "Sum");
let viv = new Queen("The Vivienne", 12, 12, 7, 10, 14, 11, 9, "true", "TVivienne");
let vinegar = new Queen("Vinegar Strokes", 7, 6, 6, 4, 4, 6, 6, "true", "Vinegar");
let uk_season1 = [baga, blu, cheryl, crystaluk, divina, gothy, scaredy, sumting, viv, vinegar];
//DRUK SEASON 2
let awhora = new Queen("A'Whora", 7, 5, 8, 15, 10, 10, 8, "true", "Awhora");
let asttina = new Queen("Asttina Mandella", 6, 6, 13, 8, 6, 10, 12, "true", "Asttina");
let bimini = new Queen("Bimini Bon-Boulash", 11, 14, 10, 7, 11, 11, 11, "true", "Bimini");
let cherry = new Queen("Cherry Valentine", 5, 6, 5, 7, 6, 11, 4, "true", "Cherry");
let ellie = new Queen("Ellie Diamond", 10, 6, 7, 11, 8, 9, 8, "true", "Ellie");
let ginny = new Queen("Ginny Lemon", 6, 6, 5, 5, 5, 8, 4, "true", "Ginny");
let joe = new Queen("Joe Black", 5, 5, 4, 5, 4, 8, 5, "true", "Joe");
let lawrence = new Queen("Lawrence Chaney", 13, 12, 5, 12, 9, 11, 9, "true", "Lawrence");
let sister = new Queen("Sister Sister", 6, 8, 6, 4, 7, 8, 9, "true", "Sister");
let tayce = new Queen("Tayce", 10, 9, 10, 5, 9, 12, 14, "true", "Tayce");
let tia = new Queen("Tia Kofi", 7, 9, 9, 5, 8, 5, 9, "true", "Tia");
let veronica = new Queen("Veronica Green", 6, 6, 10, 6, 5, 7, 8, "true", "Veronica");
...
let anubis = new Queen("Anubis", 5, 5, 5, 4, 5, 4, 4, "true", "Anubis");
let charity = new Queen("Charity Kase", 8, 7, 4, 10, 6, 13, 8, "true", "Charity");
let choriza = new Queen("Choriza May", 9, 9, 6, 7, 7, 8, 7, "true", "Choriza");
let elektraF = new Queen("Elektra Fence", 5, 6, 11, 4, 5, 8, 13, "true", "ElektraF");
let ella = new Queen("Ella Vaday", 9, 14, 8, 10, 12, 9, 8, "true", "Ella");
let kitty = new Queen("Kitty Scott-Claus", 12, 11, 7, 8, 9, 9, 7, "true", "Kitty");
let krystal = new Queen("Krystal Versace", 8, 8, 11, 12, 8, 14, 12, "true", "Krystal");
let river = new Queen("River Medway", 8, 6, 5, 9, 5, 7, 6, "true", "River");
let scarlett = new Queen("Scarlett Harlett", 7, 7, 8, 8, 6, 8, 7, "true", "ScarlettH");
let vanity = new Queen("Vanity Milan", 8, 7, 11, 5, 8, 8, 20, "Vanity");
let victoriaS = new Queen("Victoria Scone", 8, 10, 8, 7, 9, 9, 8, "true", "VictoriaS");
let uk_season3 = [anubis, charity, choriza, elektraF, ella, kitty, krystal, river, scarlett, vanity, victoriaS, veronica];
//CAN SEASON 1 
let anastarzia = new Queen("Anastarzia Anaquway", 7, 6, 4, 12, 6, 8, 7, "true", "Starzy");
let boa = new Queen("BOA", 6, 6, 5, 5, 6, 7, 7, "true", "BOA");
let ilona = new Queen("Ilona Verley", 5, 8, 5, 8, 9, 10, 9, "true", "Ilona");
let jimbo = new Queen("Jimbo", 10, 13, 2, 13, 15, 11, 2, "true", "Jimbo");
let juice = new Queen("Juice Boxx", 6, 6, 6, 4, 6, 6, 7, "true", "Juice");
let kiara = new Queen("Kiara", 10, 6, 8, 11, 6, 9, 11, "true", "Kiara");
let kyne = new Queen("Kyne", 8, 6, 6, 7, 6, 6, 7, "true", "Kyne");
let lemon = new Queen("Lemon", 10, 11, 12, 6, 11, 13, 11, "true", "Lemon");
let priyanka = new Queen("Priyanka", 14, 9, 12, 8, 6, 10, 13, "true", "Priyanka");
let rita = new Queen("Rita Baga", 10, 11, 7, 10, 9, 10, 12, "true", "Rita");
let bobo = new Queen("Scarlett BoBo", 6, 8, 9, 9, 9, 10, 9, "true", "Scarlett");
let tynomi = new Queen("Tynomi Banks", 5, 6, 5, 7, 5, 7, 9, "true", "Tynomi");
let can_season1 = [anastarzia, boa, ilona, jimbo, juice, kiara, kyne, lemon, priyanka, rita, bobo, tynomi];
//CAN SEASON 2
let adriana = new Queen("Adriana", 9, 6, 7, 6, 6, 8, 5, "true", "Adriana");
let beth = new Queen("Beth", 5, 5, 6, 3, 6, 5, 4, "true", "Beth");
let eve = new Queen("Eve 6000", 10, 5, 5, 6, 6, 8, 8, "true", "Eve");
let giametric = new Queen("Gia Metric", 9, 6, 10, 6, 6, 9, 9, "true", "Giametric");
let icesis = new Queen("Icesis Couture", 7, 8, 8, 11, 7, 10, 9, "true", "Icesis");
let kendall = new Queen("Kendall Gender", 7, 9, 9, 6, 7, 8, 9, "true", "Kendall");
let kimoraA = new Queen("Kimora Amour", 6, 5, 5, 6, 7, 7, 5, "true", "KimoraA");
let oceane = new Queen("Océane Aqua-Black", 6, 7, 4, 7, 7, 7, 5, "true", "Oceane");
let pythia = new Queen("Pythia", 8, 7, 8, 12, 9, 12, 7, "true", "Pythia");
let stephanie = new Queen("Stephanie Prince", 6, 6, 7, 10, 6, 9, 6, "true", "Stephanie");
let suki = new Queen("Suki Doll", 8, 7, 6, 9, 5, 9, 5, "true", "Suki");
let synthia = new Queen("Synthia Kiss", 6, 8, 10, 7, 9, 7, 9, "true", "Synthia");
let can_season2 = [adriana, beth, eve, giametric, icesis, kendall, kimoraA, oceane, pythia, stephanie, suki, synthia];
//DRAG RACE HOLLAND 
let chelsea = new Queen("Chelsea Boy", 9, 10, 7, 7, 10, 12, 6, "true", "Chelsea");
let envy = new Queen("Envy Peru", 11, 11, 11, 8, 11, 13, 11, "true", "Envy");
let janey = new Queen("Janey Jacké", 7, 6, 13, 11, 6, 11, 12, "true", "Janey");
let madamem = new Queen("Madame Madness", 8, 6, 5, 6, 5, 8, 7, "true", "MadameM");
let mama = new Queen("Ma'Ma Queen", 9, 6, 5, 6, 6, 10, 7, "true", "Mama");
let megan = new Queen("Megan Schoonbrood", 7, 6, 6, 5, 6, 9, 8, "true", "Megan");
let abby = new Queen("Miss Abby OMG", 5, 6, 11, 6, 5, 8, 9, "true", "Abby");
let patty = new Queen("Patty Pam-Pam", 5, 6, 6, 6, 5, 9, 7, "true", "Patty");
let roem = new Queen("Roem", 6, 6, 5, 5, 5, 6, 5, "true", "Roem");
let sederginne = new Queen("Sederginne", 7, 6, 6, 7, 5, 13, 5, "true", "Sederginne");
let hol_season1 = [chelsea, envy, janey, madamem, mama, megan, abby, patty, roem, sederginne];
//DRAG RACE HOLLAND SEASON 2
let ivyelise = new Queen("Ivy-Elyse", 6, 8, 5, 4, 8, 5, 9, "true", "IvyE");
let juicy = new Queen("Juicy Kouture", 5, 6, 5, 5, 4, 4, 5, "true", "Juicy");
let keta = new Queen("Keta Minaj", 9, 12, 9, 7, 12, 11, 9, "true", "Keta");
let love = new Queen("Love Masisi", 6, 5, 6, 8, 5, 10, 7, "true", "Love");
let mlp = new Queen("My Little Puny", 10, 10, 10, 7, 9, 10, 9, "true", "MLP");
let reggy = new Queen("Reggy B", 6, 6, 6, 5, 6, 8, 8, "true", "Reggy");
let tabitha = new Queen("Tabitha", 6, 7, 8, 6, 5, 7, 8, "true", "Tabitha");
let countess = new Queen("The Countess", 7, 5, 4, 10, 6, 12, 5, "true", "Countess");
let vanessaC = new Queen("Vanessa Van Cartier", 7, 5, 6, 8, 5, 12, 8, "true", "VanessaC");
let vivaldi = new Queen("Vivaldi", 8, 8, 8, 7, 8, 12, 8, "true", "Vivaldi");
let hol_season2 = [ivyelise, juicy, keta, love, mlp, reggy, tabitha, countess, vanessaC, vivaldi];
//DRT SEASON 1
let amadiva = new Queen("Amadiva", 9, 6, 7, 9, 3, 9, 6, "true", "Amadiva");
let annee = new Queen("Anneé Maywong", 9, 9, 7, 10, 4, 10, 9, "true", "Annee");
let b = new Queen("B Ella", 7, 9, 6, 8, 9, 7, 7, "true", "B");
let bunny = new Queen("Bunny Be Fly", 7, 5, 5, 8, 5, 8, 6, "true", "Bunny");
let dearis = new Queen("Dearis Doll", 7, 7, 7, 8, 8, 8, 8, "true", "Dearis");
let jaja = new Queen("JAJA", 8, 6, 7, 9, 5, 9, 9, "true", "Jaja");
let meannie = new Queen("Meannie Minaj", 7, 5, 5, 6, 5, 5, 5, "true", "Meannie");
let morrigan = new Queen("Morrigan", 5, 6, 7, 5, 7, 7, 7, "true", "Morrigan");
let natalia = new Queen("Natalia Pliacam", 9, 9, 7, 9, 9, 10, 9, "true", "Natalia");
let petchra = new Queen("Petchra", 7, 7, 6, 7, 8, 7, 9, "true", "Petchra");
let drt_season1 = [amadiva, annee, b, bunny, dearis, jaja, meannie, morrigan, natalia, petchra];
//DRT SEASON 2
let angele = new Queen("Angele Anang", 9, 9, 9, 9, 8, 10, 9, "true", "Angele");
let bandit = new Queen("Bandit", 7, 7, 7, 8, 6, 8, 9, "true", "Bandit");
let genie = new Queen("Genie", 9, 8, 9, 9, 7, 9, 8, "true", "Genie");
let kana = new Queen("Kana Warrior", 8, 8, 8, 7, 7, 9, 9, "true", "Kana");
let kandyz = new Queen("Kandy Zyanide", 9, 9, 9, 9, 9, 9, 7, "true", "KandyZ");
let katy = new Queen("Katy Killer", 7, 8, 7, 8, 7, 8, 8, "true", "Katy");
let m = new Queen("M Stranger Fox", 5, 6, 5, 6, 6, 8, 8, "true", "M");
let maya = new Queen("Maya B'haro", 9, 8, 6, 9, 9, 8, 7, "true", "Maya");
let mocha = new Queen("Mocha Diva", 9, 9, 6, 8, 9, 7, 9, "true", "Mocha");
let gimhuay = new Queen("Miss Gimhuay", 8, 9, 7, 9, 8, 9, 8, "true", "Gimhuay");
let silver = new Queen("Silver Sonic", 5, 5, 7, 6, 7, 7, 8, "true", "Silver");
let srimala = new Queen("Srimala", 7, 7, 8, 7, 8, 9, 9, "true", "Srimala");
let tormai = new Queen("Tormai", 8, 8, 7, 7, 6, 8, 9, "true", "Tormai");
let vanda = new Queen("Vanda Miss Joaquim", 9, 8, 9, 7, 7, 9, 9, "true", "Vanda");
let drt_season2 = [angele, bandit, genie, kana, kandyz, katy, m, maya, mocha, gimhuay, silver, srimala, tormai, vanda];
//DRAG RACE DOWN UNDER
let anita = new Queen("Anita Wigl'it", 6, 10, 8, 6, 10, 8, 5, "true", "Anita");
let art = new Queen("Art Simone", 6, 4, 5, 8, 4, 10, 4, "true", "Art");
let cocoj = new Queen("Coco Jumbo", 6, 5, 6, 6, 5, 8, 9, "true", "CocoJ");
let elektra = new Queen("Elektra Shock", 10, 6, 12, 8, 4, 7, 1, "true", "Elektra");
let etc = new Queen("Etcetera Etcetera", 5, 8, 8, 7, 8, 8, 8, "true", "Etc");
let jojo = new Queen("Jojo Zaho", 5, 5, 5, 5, 5, 6, 6, "true", "Jojo");
let kita = new Queen("Kita Mean", 9, 9, 7, 7, 9, 9, 8, "true", "Kita");
let maxi = new Queen("Maxi Shield", 6, 6, 5, 9, 7, 8, 8, "true", "Maxi");
let drdu = [anita, art, cocoj, elektra, etc, jojo, kita, maxi];
//DRAG RACE ESPAÑA 1
let arantxa = new Queen("Arantxa Castilla La Mancha", 6, 8, 6, 7, 8, 9, 7, "true", "Arantxa");
let carmenf = new Queen("Carmen Farala", 10, 10, 10, 14, 8, 13, 9, "true", "CarmenF");
let dovima = new Queen("Dovima Nurmi", 8, 7, 5, 7, 8, 10, 6, "true", "Dovima");
let drag = new Queen("Drag Vulcano", 6, 6, 5, 7, 6, 9, 6, "true", "Drag");
let hugaceo = new Queen("Hugáceo Crujiente", 5, 5, 5, 12, 6, 10, 8, "true", "Hugaceo");
let inti = new Queen("Inti", 6, 6, 6, 7, 5, 11, 6, "true", "Inti");
let killer = new Queen("Killer Queen", 6, 10, 8, 9, 11, 9, 8, "true", "Killer");
let pupi = new Queen("Pupi Poisson", 10, 11, 7, 5, 11, 6, 7, "true", "Puppy");
let sagittaria = new Queen("Sagittaria", 7, 8, 8, 9, 7, 10, 8, "true", "Sagittaria");
let macarena = new Queen("The Macarena", 5, 5, 6, 4, 5, 5, 5, "true", "Macarena");
let dres_season1 = [arantxa, carmenf, dovima, drag, hugaceo, inti, killer, pupi, sagittaria, macarena];
// DRAG RACE ESPAÑA 2
let arielRec = new Queen("Ariel Rec", 7, 7, 7, 7, 7, 7, 7, "true", "ArielRec");
let diamante = new Queen("Diamante Merybrown", 7, 7, 7, 7, 7, 7, 7, "true", "Diamante");
let sethlas = new Queen("Drag Sethlas", 7, 7, 7, 7, 7, 7, 7, "true", "DragSethlas");
let estrella = new Queen("Estrella Xtravaganza", 7, 7, 7, 7, 7, 7, 7, "true", "Estrella");
let jota = new Queen("Jota Carajota", 7, 7, 7, 7, 7, 7, 7, "true", "Jota");
let juriji = new Queen("Juriji Der Klee", 7, 7, 7, 7, 7, 7, 7, "true", "Juriji");
let marina = new Queen("Marina", 7, 7, 7, 7, 7, 7, 7, "true", "Marina");
let marisa = new Queen("Marisa Prisa", 7, 7, 7, 7, 7, 7, 7, "true", "Marisa");
let onyx = new Queen("Onyx", 7, 7, 7, 7, 7, 7, 7, "true", "Onyx");
let samantha = new Queen("Samantha Ballentines", 7, 7, 7, 7, 7, 7, 7, "true", "Samantha");
let sharonne = new Queen("Sharonne", 7, 7, 7, 7, 7, 7, 7, "true", "Sharonne");
let venedita = new Queen("Venedita Von Däsh", 7, 7, 7, 7, 7, 7, 7, "true", "Venedita");
let dres_season2 = [arielRec, diamante, sethlas, estrella, jota, juriji, marina, marisa, onyx, samantha, sharonne, venedita];
//DRAG RACE ITALIA
let ava = new Queen("Ava Hangar", 8, 7, 5, 5, 6, 6, 6, "true", "Ava");
let divinity = new Queen("Divinity", 9, 6, 8, 7, 6, 8, 7, "true", "Divinity");
let elecktra = new Queen("Elecktra Bionic", 7, 8, 8, 8, 9, 9, 8, "true", "Elecktra");
let enorma = new Queen("Enorma Jean", 8, 8, 6, 6, 8, 7, 6, "true", "Enorma");
let farida = new Queen("Farida Kant", 7, 6, 8, 11, 5, 11, 8, "true", "Farida");
let ivana = new Queen("Ivana Vamp", 6, 5, 6, 6, 6, 6, 5, "true", "Ivana");
let riche = new Queen("Le Riche", 6, 8, 6, 8, 9, 8, 7, "true", "Riche");
...
//custom s1
let lana = new Queen("Lana Ja'Rae", 6, 5, 2, 14, 7, 4, 4, "true", "Lana");
let acna = new Queen("Acna Attack", 6, 5, 2, 14, 7, 4, 4, "true", "Acna");
let betho = new Queen("Beth Oven", 6, 5, 2, 14, 7, 4, 4, "true", "BethO");
let mary = new Queen("Mary J. Wanna", 14, 7, 12, 6, 4, 10, 4, "true", "Mary");
let avenue = new Queen("Avenue", 6, 5, 2, 14, 7, 4, 4, "true", "Avenue");
let dahliam = new Queen("Dahlia Monroe", 6, 5, 2, 14, 7, 4, 4, "true", "DahliaM");
let didja = new Queen("Didja Lie", 6, 5, 2, 14, 7, 4, 4, "true", "Didja");
let ashleigh = new Queen("Ashleigh DeSleigh", 6, 5, 2, 14, 7, 4, 4, "true", "Ashleigh");
let custom1 = [lana, betho, mary, avenue, acna, dahliam, didja, ashleigh];
//custom s2
let harmony = new Queen("Harmony Falsetto", 6, 5, 2, 14, 7, 4, 4, "true", "Harmony");
let didi = new Queen("Didi Deathnote", 6, 5, 2, 14, 7, 4, 4, "true", "Didi");
let devyn = new Queen("Devyn Dynasty", 3, 3, 15, 10, 3, 12, 4, "true", "Devyn");
let cindy = new Queen("Cindy Wink", 11, 5, 13, 6, 4, 9, 4, "true", "Cindy");
let millerd = new Queen("Miller D’Lite", 6, 5, 2, 14, 7, 4, 4, "true", "MillerD");
let cherri = new Queen("Cherri Gravez", 6, 5, 2, 14, 7, 4, 4, "true", "Cherri");
let surut = new Queen("Surut", 6, 14, 4, 3, 11, 9, 4, "true", "Surut");
let coach = new Queen("Coach Ella", 6, 5, 2, 14, 7, 4, 4, "true", "Coach");
let mother = new Queen("Mother Monster", 6, 5, 2, 14, 7, 4, 4, "true", "Mother");
let trey = new Queen("Trey Angle", 4, 10, 2, 11, 13, 2, 4, "true", "Trey");
let fire = new Queen("Fire Ma'aM", 10, 4, 11, 14, 2, 8, 4, "true", "Fire");
let custom2 = [harmony, didi, devyn, cindy, millerd, cherri, surut, coach, mother, trey, fire, dahliam, mary];
//custom s3
let mike = new Queen("Mike Dragzowski", 1, 1, 1, 1, 1, 1, 4, "true", "Mike");
let venusd = new Queen("Venus Galore", 11, 8, 12, 4, 5, 3, 4, "true", "VenusG");
let terry = new Queen("Terry The Tuck", 1, 1, 1, 1, 1, 1, 4, "true", "Terry");
let jani = new Queen("Jan II", 3, 2, 3, 11, 12, 7, 4, "true", "JanI");
let heidig = new Queen("Heidi Good", 12, 10, 12, 5, 3, 2, 4, "true", "HeidiG");
let betha = new Queen("Beth Amphetamine", 6, 5, 2, 14, 7, 4, 4, "true", "BethA");
let caira = new Queen("Caira Cosplay", 6, 14, 4, 3, 11, 9, 4, "true", "Caira");
let ayehsa = new Queen("Ayesha Apocalypse", 7, 7, 7, 11, 7, 7, 4, "true", "Ayesha");
let bethl = new Queen("Beth Lahem", 1, 1, 1, 1, 1, 1, 4, "true", "BethL");
...
//custom s4
let jenner = new Queen("Jenner Myles", 1, 1, 1, 1, 1, 1, 4, "true", "Jenner");
let gusha = new Queen("Gusha", 2, 5, 3, 12, 10, 15, 4, "true", "Gusha");
let evea = new Queen("Eve Angelica", 11, 3, 4, 13, 2, 15, 4, "true", "EveA");
let taba = new Queen("Taba Co", 15, 12, 13, 4, 3, 2, 4, "true", "Taba");
let amethyst = new Queen("Amethyst Rock Bottom", 13, 12, 4, 14, 2, 3, 4, "true", "Amethyst");
let fet = new Queen("Fet Anyal", 2, 4, 15, 13, 12, 3, 4, "true", "Fet");
let fairy = new Queen("Fairy Dust", 3, 4, 15, 12, 2, 13, 4, "true", "Fairy");
let yurin = new Queen("Yurin D. Nile", 4, 15, 10, 3, 2, 11, 4, "true", "Yurin");
let virgin = new Queen("Virgin Mary", 15, 13, 12, 4, 3, 2, 4, "true", "Virgin");
let honeym = new Queen("Honey Mustard", 11, 15, 4, 13, 2, 3, 4, "true", "Honeym");
let custom4 = [jenner, gusha, evea, taba, amethyst, fet, fairy, yurin, virgin, honeym];
//custom s5
let sapphire = new Queen("Sapphire Rock Bottom", 4, 12, 13, 14, 3, 2, 4, "true", "Sapphire");
let angel = new Queen("Angel Azul", 11, 2, 13, 12, 4, 3, 4, "true", "Angel");
let gem = new Queen("Gem", 2, 3, 12, 13, 4, 14, 4, "true", "Gem");
let zombira = new Queen("Zombira", 10, 12, 2, 3, 4, 14, 4, "true", "Zombira");
let canna = new Queen("Canna Biss", 1, 1, 4, 1, 2, 3, 4, "true", "Canna");
...
alyssa]
//judges
let kellyh = new Queen("Kelly Hyland", 3, 2, 7, 3, 2, 7, 1, "true", "Kelly");
let jojos = new Queen("Jojo Siwa", 3, 2, 7, 3, 2, 7, 1, "true", "Jojos");
let kimk = new Queen("Kim Kardashian", 3, 2, 7, 3, 2, 7, 1, "true", "KimK");
let sabrina = new Queen("Sabrina Carpenter", 3, 2, 7, 3, 2, 7, 1, "true", "Sabrina");
let britney = new Queen("Britney Spears", 3, 2, 7, 3, 2, 7, 1, "true", "Britney");
