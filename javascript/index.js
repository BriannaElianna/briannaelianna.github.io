...
class ComedyChallenge {
    generateDescription() {
		...
		let whatChallengeIs = desc2[randomNumber(0, 6)];
...
//SEASON 3:
let alexis = new Queen("Alexis Mateo", 14, 12, 9, 7, 10, 8, 12, "Alexis",false, "S");
let carmen = new Queen("Carmen Carrera", 3, 8, 6, 4, 3, 7, 7, "Carmen",false, "S");
let delta = new Queen("Delta Work", 4, 6, 5, 5, 5, 7, 7, "Delta",false, "S");
let india = new Queen("India Ferrah", 6, 4, 8, 6, 3, 10, 9, "India",false, "S");
let manila = new Queen("Manila Luzon", 12, 11, 7, 14, 10, 13, 11, "Manila",false, "S");
let mariah = new Queen("Mariah Paris Balenciaga", 6, 4, 7, 8, 4, 9, 8, "Mariah",false, "S");
let mimi = new Queen("Mimi Imfurst", 11, 6, 6, 10, 7, 8, 6, "Mimi",false, "S");
let phoenix = new Queen("Phoenix", 3, 3, 6, 5, 3, 5, 4, "Phoenix",false, "S");
let raja = new Queen("Raja", 9, 11, 7, 14, 10, 10, 10, "Raja", "S");
let stacey = new Queen("Stacy Layne Matthews", 6, 7, 5, 4, 10, 5, 6, "Stacy",false, "S");
let venus = new Queen("Venus D-Lite", 4, 5, 8, 2, 3, 5, 2, "Venus",false, "S");
let yara = new Queen("Yara Sofia", 11, 9, 9, 13, 7, 10, 8, "Yara",false, "S");
let us_season3 = [alexis, carmen, delta, india, manila, mariah, mimi, phoenix, raja, shangela, stacey, venus, yara];
//SEASON 4:
let alisa = new Queen("Alisa Summers", 4, 4, 5, 2, 3, 5, 4, "Alisa",false, "S");
let chad = new Queen("Chad Michaels", 11, 10, 8, 9, 12, 10, 8, "Chad",false, "S");
let dida = new Queen("Dida Ritz", 8, 7, 8, 5, 7, 7, 12, "Dida",false, "S");
let jiggly = new Queen("Jiggly Caliente", 4, 6, 9, 4, 4, 7, 10, "Jiggly",false, "S");
let kenya = new Queen("Kenya Michaels", 9, 6, 6, 6, 8, 7, 8, "Kenya",false, "S");
let leshauwn = new Queen("Lashauwn Beyond", 4, 4, 6, 11, 5, 7, 7, "Lashauwn",false, "S");
let latrice = new Queen("Latrice Royale", 11, 8, 9, 8, 7, 9, 13, "Latrice",false, "S");
let madame = new Queen("Madame LaQueer", 4, 7, 6, 5, 9, 7, 6, "Madame",false, "S");
let milan = new Queen("Milan", 4, 5, 9, 7, 5, 8, 10, "Milan",false, "S");
let phiphi = new Queen("Jaremi", 13, 9, 8, 10, 10, 10, 8, "PhiPhi",false, "S");
let princess = new Queen("The Princess", 4, 4, 5, 7, 4, 7, 7, "Princess",false, "S");
let willam = new Queen("Willam", 10, 8, 7, 10, 10, 9, 8, "Willam",false, "S");
...
let alaska = new Queen("Alaska", 15, 14, 7, 8, 14, 10, 11, "Alaska",false, "S");
let alyssa = new Queen("Alyssa Edwards", 4, 6, 15, 6, 10, 9, 12, "Alyssa",false, "S");
let coco = new Queen("Coco Montrese", 10, 10, 11, 9, 7, 9, 15, "Coco",false, "S");
let detox = new Queen("Detox", 10, 9, 9, 9, 8, 12, 11, "Detox",false, "S");
let honey = new Queen("Honey Mahogany", 10, 3, 3, 6, 6, 8, 4, "Honey",false, "S");
let ivy = new Queen("Ivy Winters", 11, 4, 8, 12, 7, 10, 7, "Ivy",false, "S");
let jadejolie = new Queen("Jade Jolie", 5, 7, 8, 7, 8, 7, 8, "JadeJ",false, "DRAGULA");
let jinkx = new Queen("Jinkx Monsoon", 15, 14, 9, 8, 15, 8, 8, "Jinkx",false, "S");
let lineysha = new Queen("Lineysha Sparx", 10, 4, 7, 11, 5, 9, 8, "Lineysha",false, "S");
let monica = new Queen("Monica Beverly Hillz", 4, 4, 6, 6, 3, 8, 8, "Monica",false, "S");
let penny = new Queen("Penny Tration", 4, 5, 4, 5, 5, 5, 4, "Penny",false, "S");
let roxxxy = new Queen("Roxxxy Andrews", 7, 4, 7, 11, 8, 10, 12, "Roxxxy",false, "S");
let serena = new Queen("Serena ChaCha", 3, 3, 7, 4, 5, 5, 8, "Serena",false, "S");
let vivienne = new Queen("Vivienne Pinay", 7, 3, 4, 5, 3, 6, 4, "Vivienne",false, "S");
let us_season5 = [alaska, alyssa, coco, detox, honey, ivy, jadejolie, jinkx, lineysha, monica, penny, roxxxy, serena, vivienne];
//SEASON 6:
let adore = new Queen("Adore Delano", 9, 11, 9, 6, 9, 8, 11, "Adore",false, "S");
let april = new Queen("April Carrión", 5, 5, 6, 9, 5, 9, 8, "April",false, "S");
let bendelacreme = new Queen("BenDeLaCreme", 12, 12, 11, 10, 15, 10, 9, "Bendelacreme",false, "S");
let bianca = new Queen("Bianca Del Rio", 11, 15, 7, 13, 15, 10, 5, "Bianca",false, "S");
let courtney = new Queen("Courtney Act", 11, 8, 10, 10, 10, 12, 9, "Courtney",false, "S");
let darienne = new Queen("Darienne Lake", 11, 8, 7, 4, 9, 8, 13, "Darienne",false, "S");
let gia = new Queen("Gia Gunn", 10, 4, 8, 8, 4, 8, 9, "Gia",false, "S");
let joslyn = new Queen("Joslyn Fox", 6, 7, 8, 6, 8, 8, 11, "Joslyn",false, "S");
let kelly = new Queen("Kelly Mantle", 6, 6, 5, 5, 4, 7, 4, "Kellu",false, "S");
let laganja = new Queen("Laganja Estranja", 9, 5, 14, 8, 6, 10, 15, "Laganja",false, "S");
let magnolia = new Queen("Magnolia Crawford", 4, 5, 6, 4, 5, 7, 4, "Magnolia",false, "S");
let milk = new Queen("Milk", 6, 6, 7, 8, 8, 7, 7, "Milk",false, "S");
let trinityk = new Queen("Trinity K. Bonet", 9, 9, 13, 12, 4, 10, 15, "TrinityKB",false, "S");
let vivacious = new Queen("Vivacious", 4, 5, 5, 4, 4, 7, 7, "Vivacious",false, "S");
...
//SEASON 7: 
let ginger = new Queen("Ginger Minj", 14, 12, 8, 9, 15, 7, 12, "Ginger",false, "S");
let jaidynn = new Queen("Jaidynn Diore Fierce", 9, 7, 8, 6, 6, 7, 11, "Jaidynn",false, "S");
let jasmine = new Queen("Jasmine Masters", 3, 4, 6, 5, 2, 7, 6, "Jasmine",false, "S");
let kandy = new Queen("Kandy Ho", 4, 4, 7, 5, 4, 7, 10, "KandyH",false, "S");
let katya = new Queen("Katya", 9, 12, 9, 7, 12, 10, 10, "Katya",false, "S");
let kennedy = new Queen("Kennedy Davenport", 9, 8, 10, 8, 11, 10, 14, "Kennedy", "S");
let max = new Queen("Max", 10, 7, 5, 8, 4, 8, 5, "Max",false, "S");
let fame = new Queen("Miss Fame", 8, 4, 5, 11, 3, 10, 5, "MissFame",false, "S");
let kasha = new Queen("Mrs. Kasha Davis", 11, 8, 9, 8, 6, 8, 7, "Kasha",false, "S");
let pearl = new Queen("Pearl", 7, 10, 8, 9, 10, 9, 5, "Pearl",false, "S");
let sashab = new Queen("Sasha Belle", 6, 6, 4, 4, 6, 6, 4, "SashaB",false, "S");
let tempest = new Queen("Tempest DuJour", 6, 6, 5, 3, 6, 7, 4, "Tempest",false, "S");
let trixie = new Queen("Trixie Mattel", 13, 10, 6, 10, 11, 10, 5, "Trixie",false, "S");
let violet = new Queen("Violet Chachki", 6, 7, 8, 15, 8, 13, 8, "Violet",false, "S");
...
let acid = new Queen("Acid Betty", 9, 4, 7, 10, 5, 11, 7, "Acid",false, "S");
let bob = new Queen("Bob The Drag Queen", 15, 15, 8, 9, 15, 8, 12, "Bob",false, "S");
let chichi = new Queen("Chi Chi DeVayne", 8, 4, 13, 8, 6, 8, 13, "ChiChi",false, "S");
let cynthia = new Queen("Cynthia Lee Fontaine", 4, 4, 7, 6, 4, 7, 6, "Cynthia",false, "S");
let dax = new Queen("Dax ExclamationPoint", 5, 6, 6, 5, 6, 5, 4, "Dax",false, "S");
let derrick = new Queen("Derrick Barry", 7, 7, 8, 8, 9, 7, 8, "Derrick",false, "S");
let kim = new Queen("Kim Chi", 10, 7, 4, 15, 8, 13, 4, "Kim",false, "S");
let laila = new Queen("Laila McQueen", 6, 6, 4, 7, 6, 8, 7, "Laila",false, "S");
let naomi = new Queen("Naomi Smalls", 9, 7, 10, 14, 10, 12, 11, "Naomi",false, "S");
let naysha = new Queen("Naysha Lopez", 6, 4, 4, 4, 3, 6, 7, "Naysga",false, "S");
let robbie = new Queen("Robbie Turner", 4, 5, 6, 4, 3, 6, 6, "Robbie",false, "S");
let thorgy = new Queen("Thorgy Thor", 14, 9, 6, 9, 13, 9, 8, "Thorgy",false, "S");
...
//SEASON 9: 
let aja = new Queen("Aja", 4, 8, 12, 11, 9, 10, 11, "Aja",false, "S");
let alexism = new Queen("Alexis Michelle", 8, 7, 9, 7, 13, 6, 10, "AlexisM",false, "S");
let charlie = new Queen("Charlie Hides", 10, 6, 5, 7, 4, 9, 2, "Charlie",false, "S");
let eureka = new Queen("Eureka!", 9, 11, 8, 10, 13, 10, 12, "Eureka",false, "S");
let farrah = new Queen("Farrah Moan", 9, 4, 7, 3, 6, 8, 7, "Farrah",false, "S");
let jaymes = new Queen("Jaymes Mansfield", 6, 6, 3, 6, 5, 7, 6, "Jaymes",false, "S");
let kimora = new Queen("Kimora Blac", 5, 5, 4, 6, 5, 8, 7, "Kimora",false, "S");
let ninab = new Queen("Nina Bo'Nina Brown", 4, 8, 10, 9, 10, 10, 11, "NinaBB",false, "S");
let peppermint = new Queen("Peppermint", 11, 9, 10, 9, 4, 7, 13, "Peppermint",false, "S");
let sasha = new Queen("Sasha Velour", 9, 10, 8, 10, 11, 13, 11, "Sasha",false, "S");
let shea = new Queen("Shea Couleé", 12, 12, 14, 12, 13, 12, 13, "Shea",false, "S");
let trinity = new Queen("Trinity The Tuck", 13, 10, 8, 10, 8, 9, 12, "TrinityTT",false, "S");
let valentina = new Queen("Valentina", 11, 7, 10, 9, 9, 9, 10, "Valentina",false, "S");
...
//SEASON 10: 
let aquaria = new Queen("Aquaria", 6, 11, 8, 15, 12, 14, 11, "Aquaria",false, "S");
let asia = new Queen("Asia O'Hara", 11, 9, 6, 6, 7, 9, 9, "Asia",false, "S");
let blair = new Queen("Blair St. Clair", 9, 8, 6, 10, 8, 8, 7, "Blair",false, "S");
let dusty = new Queen("Dusty Ray Bottoms", 8, 8, 6, 7, 6, 7, 6, "Dusty",false, "S");
let kalorie = new Queen("Kalorie K. Williams", 6, 6, 6, 5, 7, 7, 8, "Kalorie",false, "S");
let kameron = new Queen("Kameron Michaels", 5, 8, 14, 10, 8, 8, 15, "Kameron",false, "S");
let mayhem = new Queen("Mayhem Miller", 4, 8, 9, 13, 7, 9, 10, "Mayhem",false, "S");
let miz = new Queen("Miz Cracker", 13, 11, 5, 12, 15, 9, 5, "Miz",false, "S");
let monet = new Queen("Monét X Change", 9, 11, 13, 6, 10, 9, 14, "Monet",false, "S");
let monique = new Queen("Mo Heart", 12, 9, 8, 11, 15, 13, 10, "Monique",false, "S");
let vanessa = new Queen("Vanessa 'Vanjie' Mateo", 9, 6, 8, 6, 9, 7, 11, "Vanjie",false, "S");
let vixen = new Queen("The Vixen", 5, 4, 12, 9, 3, 8, 12, "Vixen",false, "S");
let yuhua = new Queen("Yuhua Hamasaki", 4, 4, 6, 9, 6, 7, 7, "Yuhua",false, "S");
...
let akeria = new Queen("A'keria C. Davenport", 11, 9, 11, 8, 10, 13, 10, "Akeria",false, "S");
let ariel = new Queen("Ariel Versace", 8, 6, 8, 5, 8, 8, 8, "Ariel",false, "S");
let brooke = new Queen("Brooke Lynn Hytes", 8, 8, 13, 12, 8, 10, 13, "Brooke", false,"S");
let honeyd = new Queen("Honey Davenport", 4, 6, 5, 7, 4, 9, 4, "HoneyD", false,"S");
let kahanna = new Queen("Kahanna Montrese", 4, 5, 5, 4, 5, 6, 8, "Kahanna",false, "S");
let mercedes = new Queen("Mercedes Iman Diamond", 4, 6, 4, 6, 6, 8, 8, "Mercedes",false, "S");
let ninaw = new Queen("Nina West", 12, 11, 6, 8, 11, 8, 6, "NinaW",false, "S");
...
//SEASON 12: 
let aiden = new Queen("Aiden Zhane", 9, 3, 6, 4, 3, 6, 6, "Aiden",false, "S");
let brita = new Queen("Brita", 7, 8, 7, 4, 6, 8, 11, "Brita",false, "S");
let crystal = new Queen("Crystal Methyd", 6, 8, 8, 9, 8, 12, 6, "CrystalM",false, "S");
let dahlia = new Queen("Dahlia Sin", 4, 4, 6, 5, 5, 10, 4, "Dahlia",false, "S");
let gigi = new Queen("Gigi Goode", 10, 11, 11, 13, 9, 12, 8, "Gigi",false, "S");
let heidi = new Queen("Heidi N Closet", 6, 9, 11, 6, 12, 7, 13, "Heidi",false, "S");
let jackie = new Queen("Jackie Cox", 11, 12, 6, 6, 13, 9, 11, "Jackie",false, "S");
let jaida = new Queen("Jaida Essence Hall", 4, 7, 10, 13, 8, 10, 12, "Jaida",false, "S");
let jan = new Queen("Jan", 8, 4, 12, 9, 5, 10, 9, "Jan",false, "S");
let nicky = new Queen("Nicky Doll", 4, 4, 5, 12, 3, 11, 5, "Nicky",false, "S");
let rock = new Queen("Rock M. Sakura", 6, 6, 6, 4, 8, 8, 7, "Rock",false, "S");
let widow = new Queen("Widow Von'Du", 11, 7, 13, 8, 11, 10, 15, "Widow",false, "S");
...
//SEASON 13
let denali = new Queen("Denali", 4, 8, 14, 9, 10, 11, 13, "Denali",false, "S");
let elliott = new Queen("Elliott With 2 Ts", 5, 5, 12, 9, 3, 8, 11, "Elliott",false, "S");
let mik = new Queen("Gottmik", 8, 11, 6, 13, 12, 13, 6, "Gottmik",false, "S");
let joey = new Queen("Joey Jay", 6, 7, 6, 5, 5, 7, 7, "Joey",false, "S");
let kahmora = new Queen("Kahmora Hall", 3, 4, 3, 5, 4, 12, 4, "Kahmora", false,"S");
let kandym = new Queen("Kandy Muse", 9, 10, 5, 6, 7, 8, 14, "KandyM",false, "S");
let lala = new Queen("LaLa Ri", 5, 7, 10, 2, 6, 9, 14, "Lala",false, "S");
let olivia = new Queen("Olivia Lux", 11, 5, 11, 10, 8, 11, 8, "Olivia",false, "S");
let rose = new Queen("Rosé", 12, 11, 13, 8, 10, 10, 6, "Rose",false, "S");
let symone = new Queen("Symone", 14, 7, 7, 9, 12, 9, 13, "Symone",false, "S");
let tamisha = new Queen("Tamisha Iman", 7, 6, 7, 5, 6, 7, 7, "Tamisha",false, "S");
let tina = new Queen("Tina Burner", 6, 6, 10, 5, 6, 8, 9, "TinaB",false, "S");
let utica = new Queen("Utica Queen", 7, 4, 6, 15, 5, 12, 11, "Utica",false, "S");
...
let alyssaH = new Queen("Alyssa Hunter", 5, 6, 7, 10, 7, 13, 8, "AlyssaH",false, "S");
let angeria = new Queen("Angeria Paris VanMicheals", 11, 6, 9, 12, 8, 11, 8, "Angeria",false,"S");
let bosco = new Queen("Bosco", 11, 12, 6, 7, 12, 11, 6, "Bosco",false, "S");
let daya = new Queen("Daya Betty", 9, 8, 9, 9, 10, 10, 8, "DayaBetty",false, "S");
let deja = new Queen("DeJa Skye", 9, 7, 9, 8, 13, 8, 8, "DeJa",false, "S");
let jasmineK = new Queen("Jasmine Kennedie", 7, 6, 13, 7, 6, 10, 14, "JasmineK",false, "S");
let jorgeous = new Queen("Jorgeous", 5, 5, 13, 10, 5, 10, 15, "Jorgeous",false, "S");
let june = new Queen("June Jambalaya", 5, 6, 6, 4, 5, 6, 6, "June",false, "S");
let kerri = new Queen("Kerri Colby", 6, 6, 5, 5, 6, 9, 6, "Kerri",false, "S");
let kornbread = new Queen("Kornbread Jeté", 12, 10, 6, 7, 10, 9, 8, "Kornbread",false, "S");
let cadmen = new Queen("Lady Camden", 12, 11, 12, 11, 7, 10, 11, "LadyCamden",false, "S");
let maddy = new Queen("Maddy Morphosis", 8, 7, 6, 5, 6, 9, 7, "Maddy",false, "S");
let orion = new Queen("Orion Story", 4, 6, 6, 5, 6, 6, 9, "Orion",false, "S");
let willow = new Queen("Willow Pill", 11, 8, 7, 10, 10, 12, 8, "Willow",false, "S");
let us_season14 = [alyssaH, angeria, bosco, daya, deja, jasmineK, jorgeous, june, kerri, kornbread, cadmen, maddy, orion, willow];
//SEASON 15
let amethystt = new Queen("Amethyst", 5, 6, 7, 10, 7, 13, 8, "Amethystt",false, "S");
let anetra = new Queen("Anetra", 11, 6, 9, 12, 8, 11, 8, "Anetra",false,"S");
let aura = new Queen("Aura Mayari", 11, 12, 6, 7, 12, 11, 6, "Aura",false, "S");
let irene = new Queen("Irene Dubois", 9, 8, 9, 9, 10, 10, 8, "Irene",false, "S");
let jax = new Queen("Jax", 9, 7, 9, 8, 13, 8, 8, "Jax",false, "S");
let luxx = new Queen("Luxx Noir London", 7, 6, 13, 7, 6, 10, 14, "Luxx",false, "S");
let marcia = new Queen("Marcia Marcia Marcia", 5, 5, 13, 10, 5, 10, 15, "Marcia",false, "S");
let mistress = new Queen("Mistress Isabelle Brooks", 5, 6, 6, 4, 5, 6, 6, "Mistress",false, "S");
let poppy = new Queen("Princess Poppy", 6, 6, 5, 5, 6, 9, 6, "Poppy",false, "S");
let robin = new Queen("Robin Fierce", 12, 10, 6, 7, 10, 9, 8, "Robin",false, "S");
let salina = new Queen("Salina Estitties", 12, 11, 12, 11, 7, 10, 11, "Salina",false, "S");
let sashac = new Queen("Sasha Colby", 8, 7, 6, 5, 6, 9, 7, "SashaC",false, "S");
let sugar = new Queen("Sugar", 0, 0, 0, 0, 0, 0, 0, "Sugar",false, "S");
let spice = new Queen("Spice", 0, 0, 0, 0, 0, 0, 0, "Spice",false, "S");
...
//CAN SEASON 1 
let anastarzia = new Queen("Anastarzia Anaquway", 7, 6, 4, 12, 6, 8, 7, "Starzy", "CAN");
let boa = new Queen("BOA", 6, 6, 5, 5, 6, 7, 7, "BOA",false, "CAN");
let ilona = new Queen("Ilona Verley", 5, 8, 5, 8, 9, 10, 10, "Ilona",false, "CAN");
let jimbo = new Queen("Jimbo", 10, 13, 2, 13, 15, 11, 2, "Jimbo",false, "CAN");
let juice = new Queen("Juice Boxx", 6, 6, 6, 4, 6, 6, 7, "Juice",false, "CAN");
let kiara = new Queen("Kiara", 10, 6, 8, 11, 6, 9, 11, "Kiara",false, "CAN");
let kyne = new Queen("Kyne", 8, 6, 6, 7, 6, 6, 7, "Kyne",false, "CAN");
let lemon = new Queen("Lemon", 10, 11, 12, 6, 11, 13, 11, "Lemon",false, "CAN");
let priyanka = new Queen("Priyanka", 14, 9, 12, 8, 6, 10, 13, "Priyanka",false, "CAN");
let rita = new Queen("Rita Baga", 10, 11, 7, 10, 9, 10, 12, "Rita",false, "CAN");
let bobo = new Queen("Scarlett BoBo", 6, 8, 9, 9, 9, 10, 9, "Scarlett",false, "CAN");
let tynomi = new Queen("Tynomi Banks", 5, 6, 5, 7, 5, 7, 10, "Tynomi",false, "CAN");
let can_season1 = [anastarzia, boa, ilona, jimbo, juice, kiara, kyne, lemon, priyanka, rita, bobo, tynomi];
//CAN SEASON 2
let adriana = new Queen("Adriana", 9, 6, 7, 6, 6, 8, 5, "Adriana",false, "CAN");
let beth = new Queen("Beth", 5, 5, 6, 3, 6, 5, 4, "Beth",false, "CAN");
let eve = new Queen("Eve 6000", 10, 5, 5, 6, 6, 8, 8, "Eve",false, "CAN");
let giametric = new Queen("Gia Metric", 9, 6, 10, 6, 6, 9, 10, "Giametric",false, "CAN");
let icesis = new Queen("Icesis Couture", 7, 8, 8, 11, 7, 10, 10, "Icesis",false, "CAN");
let kendall = new Queen("Kendall Gender", 7, 9, 9, 6, 7, 8, 10, "Kendall",false, "CAN");
let kimoraA = new Queen("Kimora Amour", 6, 5, 5, 6, 7, 7, 5, "KimoraA",false, "CAN");
let oceane = new Queen("Océane Aqua-Black", 6, 7, 4, 7, 7, 7, 5, "Oceane",false, "CAN");
let pythia = new Queen("Pythia", 8, 7, 8, 12, 9, 12, 7, "Pythia",false, "CAN");
let stephanie = new Queen("Stephanie Prince", 6, 6, 7, 10, 6, 9, 6, "Stephanie",false, "CAN");
let suki = new Queen("Suki Doll", 8, 7, 6, 9, 5, 9, 5, "Suki",false, "CAN");
let synthia = new Queen("Synthia Kiss", 6, 8, 10, 7, 9, 7, 9, "Synthia",false, "CAN");
let can_season2 = [adriana, beth, eve, giametric, icesis, kendall, kimoraA, oceane, pythia, stephanie, suki, synthia];
//DRAG RACE HOLLAND 
let chelsea = new Queen("Chelsea Boy", 9, 10, 7, 7, 10, 12, 6, "Chelsea",false, "HO");
let envy = new Queen("Envy Peru", 11, 11, 11, 8, 11, 13, 11, "Envy",false, "HO");
let janey = new Queen("Janey Jacké", 7, 6, 13, 11, 6, 11, 12, "Janey",false, "HO");
let madamem = new Queen("Madame Madness", 8, 6, 5, 6, 5, 8, 7, "MadameM",false, "HO");
let mama = new Queen("Ma'Ma Queen", 9, 6, 5, 6, 6, 10, 7, "Mama",false, "HO");
let megan = new Queen("Megan Schoonbrood", 7, 6, 6, 5, 6, 9, 8, "Megan",false, "HO");
let abby = new Queen("Miss Abby OMG", 5, 6, 11, 6, 5, 8, 10, "Abby",false, "HO");
let patty = new Queen("Patty Pam-Pam", 5, 6, 6, 6, 5, 9, 7, "Patty",false, "HO");
let roem = new Queen("Roem", 6, 6, 5, 5, 5, 6, 5, "Roem",false, "HO");
let sederginne = new Queen("Sederginne", 7, 6, 6, 7, 5, 13, 5, "Sederginne",false, "HO");
let hol_season1 = [chelsea, envy, janey, madamem, mama, megan, abby, patty, roem, sederginne];
//DRAG RACE HOLLAND SEASON 2
let ivyelise = new Queen("Ivy-Elyse", 6, 8, 5, 4, 8, 5, 10, "IvyE",false, "HO");
let juicy = new Queen("Juicy Kouture", 5, 6, 5, 5, 4, 4, 5, "Juicy",false, "HO");
let keta = new Queen("Keta Minaj", 9, 12, 9, 7, 12, 11, 9, "Keta",false, "HO");
let love = new Queen("Love Masisi", 6, 5, 6, 8, 5, 10, 7, "Love",false, "HO");
let mlp = new Queen("My Little Puny", 10, 10, 10, 7, 9, 10, 10, "MLP",false, "HO");
let reggy = new Queen("Reggy B", 6, 6, 6, 5, 6, 8, 8, "Reggy",false, "HO");
let tabitha = new Queen("Tabitha", 6, 7, 8, 6, 5, 7, 8, "Tabitha",false, "HO");
let countess = new Queen("The Countess", 7, 5, 4, 10, 6, 12, 5, "Countess",false, "HO");
let vanessaC = new Queen("Vanessa Van Cartier", 7, 5, 6, 8, 5, 12, 8, "VanessaC",false, "HO");
let vivaldi = new Queen("Vivaldi", 8, 8, 8, 7, 8, 12, 8, "Vivaldi",false, "HO");
let hol_season2 = [ivyelise, juicy, keta, love, mlp, reggy, tabitha, countess, vanessaC, vivaldi];
//DRT SEASON 1
let amadiva = new Queen("Amadiva", 9, 6, 7, 9, 3, 9, 6, "Amadiva",false, "TH");
let annee = new Queen("Anneé Maywong", 9, 9, 7, 10, 4, 10, 9, "Annee",false, "TH");
let b = new Queen("B Ella", 7, 9, 6, 8, 9, 7, 7, "B",false, "TH");
let bunny = new Queen("Bunny Be Fly", 7, 5, 5, 8, 5, 8, 6, "Bunny",false, "TH");
let dearis = new Queen("Dearis Doll", 7, 7, 7, 8, 8, 8, 8, "Dearis",false, "TH");
let jaja = new Queen("JAJA", 8, 6, 7, 9, 5, 9, 9, "Jaja",false, "TH");
let meannie = new Queen("Meannie Minaj", 7, 5, 5, 6, 5, 5, 5, "Meannie",false, "TH");
let morrigan = new Queen("Morrigan", 5, 6, 7, 5, 7, 7, 7, "Morrigan",false, "TH");
let natalia = new Queen("Natalia Pliacam", 9, 9, 7, 9, 9, 10, 9, "Natalia",false, "TH");
let petchra = new Queen("Petchra", 7, 7, 6, 7, 8, 7, 9, "Petchra",false, "TH");
let drt_season1 = [amadiva, annee, b, bunny, dearis, jaja, meannie, morrigan, natalia, petchra];
//DRT SEASON 2
let angele = new Queen("Angele Anang", 9, 9, 9, 9, 8, 10, 10, "Angele",false, "TH");
let bandit = new Queen("Bandit", 7, 7, 7, 8, 6, 8, 9, "Bandit",false, "TH");
let genie = new Queen("Genie", 9, 8, 9, 9, 7, 9, 8, "Genie",false, "TH");
let kana = new Queen("Kana Warrior", 8, 8, 8, 7, 7, 9, 10, "Kana",false, "TH");
let kandyz = new Queen("Kandy Zyanide", 9, 9, 9, 9, 9, 9, 7, "KandyZ",false, "TH");
let katy = new Queen("Katy Killer", 7, 8, 7, 8, 7, 8, 8, "Katy",false, "TH");
let m = new Queen("M Stranger Fox", 5, 6, 5, 6, 6, 8, 8, "M",false, "TH");
let maya = new Queen("Maya B'haro", 9, 8, 6, 9, 9, 8, 7, "Maya",false, "TH");
let mocha = new Queen("Mocha Diva", 9, 9, 6, 8, 9, 7, 9, "Mocha",false, "TH");
let gimhuay = new Queen("Miss Gimhuay", 8, 9, 7, 9, 8, 9, 8, "Gimhuay",false, "TH");
let silver = new Queen("Silver Sonic", 5, 5, 7, 6, 7, 7, 8, "Silver",false, "TH");
let srimala = new Queen("Srimala", 7, 7, 8, 7, 8, 9, 9, "Srimala",false, "TH");
let tormai = new Queen("Tormai", 8, 8, 7, 7, 6, 8, 9, "Tormai",false, "TH");
let vanda = new Queen("Vanda Miss Joaquim", 9, 8, 9, 7, 7, 9, 9, "Vanda",false, "TH");
let drt_season2 = [angele, bandit, genie, kana, kandyz, katy, m, maya, mocha, gimhuay, silver, srimala, tormai, vanda];
//DRAG RACE DOWN UNDER
let anita = new Queen("Anita Wigl'it", 6, 10, 8, 6, 10, 8, 5, "Anita",false, "DU");
let art = new Queen("Art Simone", 6, 4, 5, 8, 4, 10, 4, "Art",false, "DU");
let cocoj = new Queen("Coco Jumbo", 6, 5, 6, 6, 5, 8, 10, "CocoJ",false, "DU");
let elektra = new Queen("Elektra Shock", 10, 6, 12, 8, 4, 7, 11, "Elektra",false, "DU");
let etc = new Queen("Etcetera Etcetera", 5, 8, 8, 7, 8, 8, 8, "Etc",false, "DU");
let jojo = new Queen("Jojo Zaho", 5, 5, 5, 5, 5, 6, 6, "Jojo",false, "DU");
let karen = new Queen("Karen From Finance", 5, 6, 5, 5, 7, 7, 5, "Karen",false, "DU");
let kita = new Queen("Kita Mean", 9, 9, 7, 7, 9, 9, 8, "Kita",false, "DU");
let maxi = new Queen("Maxi Shield", 6, 6, 5, 9, 7, 8, 8, "Maxi",false, "DU");
let drdu = [anita, art, cocoj, elektra, etc, jojo, karen, kita, maxi];
//DRAG RACE ESPAÑA 1
let arantxa = new Queen("Arantxa Castilla La Mancha", 6, 8, 6, 7, 8, 9, 7, "Arantxa",false, "ES");
let carmenf = new Queen("Carmen Farala", 10, 10, 10, 14, 8, 13, 10, "CarmenF",false, "ES");
let dovima = new Queen("Dovima Nurmi", 8, 7, 5, 7, 8, 10, 6, "Dovima",false, "ES");
let drag = new Queen("Drag Vulcano", 6, 6, 5, 7, 6, 9, 6, "Drag",false, "ES");
let hugaceo = new Queen("Hugáceo Crujiente", 5, 5, 5, 12, 6, 10, 8, "Hugaceo",false, "ES");
let inti = new Queen("Inti", 6, 6, 6, 7, 5, 11, 6, "Inti",false, "ES");
let killer = new Queen("Killer Queen", 6, 10, 8, 9, 11, 9, 8, "Killer",false, "ES");
let pupi = new Queen("Pupi Poisson", 10, 11, 7, 5, 11, 6, 7, "Puppy",false, "ES");
let sagittaria = new Queen("Sagittaria", 7, 8, 8, 9, 7, 10, 8, "Sagittaria",false, "ES");
let macarena = new Queen("The Macarena", 5, 5, 6, 4, 5, 5, 5, "Macarena",false, "ES");
let dres_season1 = [arantxa, carmenf, dovima, drag, hugaceo, inti, killer, pupi, sagittaria, macarena];
// DRAG RACE ESPAÑA 2
let arielRec = new Queen("Ariel Rec", 7, 7, 7, 7, 7, 7, 7, "ArielRec",false, "ES");
let diamante = new Queen("Diamante Merybrown", 7, 7, 7, 7, 7, 7, 7, "Diamante",false, "ES");
let sethlas = new Queen("Drag Sethlas", 7, 7, 7, 7, 7, 7, 7, "DragSethlas",false, "ES");
let estrella = new Queen("Estrella Xtravaganza", 7, 7, 7, 7, 7, 7, 7, "Estrella",false, "ES");
let jota = new Queen("Jota Carajota", 7, 7, 7, 7, 7, 7, 7, "Jota",false, "ES");
let juriji = new Queen("Juriji Der Klee", 7, 7, 7, 7, 7, 7, 7, "Juriji",false, "ES");
let marina = new Queen("Marina", 7, 7, 7, 7, 7, 7, 7, "Marina",false, "ES");
let marisa = new Queen("Marisa Prisa", 7, 7, 7, 7, 7, 7, 7, "Marisa",false, "ES");
let onyx = new Queen("Onyx", 7, 7, 7, 7, 7, 7, 7, "Onyx",false, "ES");
let samantha = new Queen("Samantha Ballentines", 7, 7, 7, 7, 7, 7, 7, "Samantha",false, "ES");
let sharonne = new Queen("Sharonne", 7, 7, 7, 7, 7, 7, 7, "Sharonne",false, "ES");
let venedita = new Queen("Venedita Von Däsh", 7, 7, 7, 7, 7, 7, 7, "Venedita",false, "ES");
let dres_season2 = [arielRec, diamante, sethlas, estrella, jota, juriji, marina, marisa, onyx, samantha, sharonne, venedita];
//DRAG RACE ITALIA
let ava = new Queen("Ava Hangar", 8, 7, 5, 5, 6, 6, 6, "Ava",false, "IT");
let divinity = new Queen("Divinity", 9, 6, 8, 7, 6, 8, 7, "Divinity",false, "IT");
let elecktra = new Queen("Elecktra Bionic", 7, 8, 8, 8, 9, 9, 8, "Elecktra",false, "IT");
let enorma = new Queen("Enorma Jean", 8, 8, 6, 6, 8, 7, 6, "Enorma",false, "IT");
let farida = new Queen("Farida Kant", 7, 6, 8, 11, 5, 11, 8, "Farida",false, "IT");
let ivana = new Queen("Ivana Vamp", 6, 5, 6, 6, 6, 6, 5, "Ivana",false, "IT");
let riche = new Queen("Le Riche", 6, 8, 6, 8, 9, 8, 7, "Riche",false, "IT");
let luquisha = new Queen("Luquisha Lubamba", 7, 6, 6, 5, 7, 6, 7, "Luquisha",false, "IT");
let italia = [ava, divinity, elecktra, enorma, farida, ivana, riche, luquisha];
//UK4
let baby = new Queen("Baby", 5, 5, 5, 4, 5, 4, 4, "Baby",false, "UK");
let peppa = new Queen("Black Peppa", 6, 11, 15, 6, 9, 15, 200, "BlackPeppa",false, "UK");
...
//DRAGULA S2
let felony = new Queen("Felony Dodger", 6, 5, 2, 3, 7, 4, 4, "Felony",false, "DRAGULA");
let monikkie = new Queen("Monikkie Shame", 6, 5, 2, 3, 7, 4, 4, "Monikkie",false, "DRAGULA");
let kendra = new Queen("Kendra Onixxx", 6, 5, 2, 3, 7, 4, 4, "Kendra",false, "DRAGULA");
let dahli = new Queen("Dahli", 6, 5, 2, 3, 7, 4, 4, "Dahli",false, "DRAGULA");
let erika = new Queen("Erika Klash", 6, 5, 2, 3, 7, 4, 4, "Erika",false, "DRAGULA");
let disasterina = new Queen("Disasterina", 6, 5, 2, 3, 7, 4, 4, "Disasterina",false, "DRAGULA");
let victoriae = new Queen("Victoria Elizabeth Black", 6, 5, 2, 3, 7, 4, 4, "VictoriaD",false, "DRAGULA");
let james = new Queen("James Majesty", 6, 5, 2, 3, 7, 4, 4, "James",false, "DRAGULA");
let biqtch = new Queen("Biqtch Puddin", 6, 5, 2, 3, 7, 4, 4, "Biqtch",false, "DRAGULA");
let dragula_2 = [felony, monikkie, kendra, dahli, erika, disasterina, victoriae, james, biqtch];
//DRAGULA S1
let pinche = new Queen("Pinche Queen", 6, 5, 2, 3, 7, 4, 4, "Pinche",false, "DRAGULA");
let ursula = new Queen("Ursula Major", 6, 5, 2, 3, 7, 4, 4, "Ursula",false, "DRAGULA");
let foxie = new Queen("Foxie Adjuia", 6, 5, 2, 3, 7, 4, 4, "Foxie",false, "DRAGULA");
let xochi = new Queen("Xochi Mochi", 6, 5, 2, 3, 7, 4, 4, "Xochi",false, "DRAGULA");
let loris = new Queen("Loris", 6, 5, 2, 3, 7, 4, 4, "Loris",false, "DRAGULA");
let meatball = new Queen("Meatball", 6, 5, 2, 3, 7, 4, 4, "Meatball",false, "DRAGULA");
let melissa = new Queen("Melissa Befierce", 6, 5, 2, 3, 7, 4, 4, "Melissa",false, "DRAGULA");
let frankie = new Queen("Frankie Doom", 6, 5, 2, 3, 7, 4, 4, "Frankie",false, "DRAGULA");
let vander = new Queen("Vander Von Odd", 6, 5, 2, 3, 7, 4, 4, "Vander",false, "DRAGULA");
let dragula_1 = [pinche, frankie, melissa, meatball, loris, xochi, vander, foxie];
//DRAGULA S3
let violencia = new Queen("Violencia!", 6, 5, 2, 3, 7, 4, 4, "Violencia",false, "DRAGULA");
let saint = new Queen("Saint", 6, 5, 2, 3, 7, 4, 4, "Saint",false, "DRAGULA");
let yovska = new Queen("Yovska", 6, 5, 2, 3, 7, 4, 4, "Yovska",false, "DRAGULA");
let maxig = new Queen("Maxi Glamour", 6, 5, 2, 3, 7, 4, 4, "MaxiD",false, "DRAGULA");
let hollow = new Queen("Hollow Eve", 6, 5, 2, 3, 7, 4, 4, "Hollow",false, "DRAGULA");
let maddelynn = new Queen("Maddelynn Hatter", 6, 5, 2, 3, 7, 4, 4, "Madelynn",false, "DRAGULA");
let evah = new Queen("Evah Destruction", 6, 5, 2, 3, 7, 4, 4, "Evah",false, "DRAGULA");
let louisianna = new Queen("Louisianna Purchase", 6, 5, 2, 3, 7, 4, 4, "Louisianna",false, "DRAGULA");
let priscillac = new Queen("Priscilla", 6, 5, 2, 3, 7, 4, 4, "PriscillaD",false, "DRAGULA");
let dollya = new Queen("Dollya Black", 6, 5, 2, 3, 7, 4, 4, "Dollya",false, "DRAGULA");
let landon = new Queen("Landon Cider", 6, 5, 2, 3, 7, 4, 4, "Landon",false, "DRAGULA");
let dragula_3 = [violencia, saint, yovska, maxig, hollow, maddelynn, evah, louisianna, priscillac, dollya, landon];
//DRAGULA S4
let formelda = new Queen("Formelda Hyde", 6, 5, 2, 3, 7, 4, 4, "Formelda",false, "DRAGULA");
let astrud = new Queen("Astrud Aurelia", 6, 5, 2, 3, 7, 4, 4, "Astrud",false, "DRAGULA");
let koco = new Queen("Koco Caine", 6, 5, 2, 3, 7, 4, 4, "Koco",false, "DRAGULA");
let merrie = new Queen("Merrie Cherry", 6, 5, 2, 3, 7, 4, 4, "Merrie",false, "DRAGULA");
let bitter = new Queen("Bitter Betty", 6, 5, 2, 3, 7, 4, 4, "Bitter",false, "DRAGULA");
let la = new Queen("La Zavaleta", 6, 5, 2, 3, 7, 4, 4, "La",false, "DRAGULA");
let sigourney = new Queen("Sigourney Beaver", 6, 5, 2, 3, 7, 4, 4, "Sigourney",false, "DRAGULA");
let hoso = new Queen("HoSo Terra Toma", 6, 5, 2, 14, 7, 4, 4, "HoSo",false, "DRAGULA");
...
//custom s1
let lana = new Queen("Lana Ja'Rae", 6, 5, 2, 14, 7, 4, 4, "Lana",false, "IT");
let acna = new Queen("Acna Attack", 6, 5, 2, 14, 7, 4, 4, "Acna",false, "IT");
let betho = new Queen("Beth Oven", 6, 5, 2, 14, 7, 4, 4, "BethO",false, "IT");
let mary = new Queen("Mary J. Wanna", 14, 7, 12, 6, 4, 10, 4, "Mary",false, "IT");
let avenue = new Queen("Avenue", 6, 5, 2, 14, 7, 4, 4, "Avenue",false, "IT");
let dahliam = new Queen("Dahlia Monroe", 6, 5, 2, 14, 7, 4, 4, "DahliaM",false, "IT");
let didja = new Queen("Didja Lie", 6, 5, 2, 14, 7, 4, 4, "Didja",false, "IT");
let ashleigh = new Queen("Ashleigh DeSleigh", 6, 5, 2, 14, 7, 4, 4, "Ashleigh",false, "IT");
let custom1 = [lana, betho, mary, avenue, acna, dahliam, didja, ashleigh];
//custom s2
let harmony = new Queen("Harmony Falsetto", 6, 5, 2, 14, 7, 4, 4, "Harmony",false, "IT");
let didi = new Queen("Didi Deathnote", 6, 5, 2, 14, 7, 4, 4, "Didi",false, "IT");
let devyn = new Queen("Devyn Dynasty", 3, 3, 15, 10, 3, 12, 4, "Devyn",false, "IT");
let cindy = new Queen("Cindy Wink", 11, 5, 13, 6, 4, 9, 4, "Cindy",false, "IT");
let millerd = new Queen("Miller D’Lite", 6, 5, 2, 14, 7, 4, 4, "MillerD",false, "IT");
let cherri = new Queen("Cherri Gravez", 6, 5, 2, 14, 7, 4, 4, "Cherri",false, "IT");
let surut = new Queen("Surut", 6, 14, 4, 3, 11, 9, 4, "Surut",false, "IT");
let coach = new Queen("Coach Ella", 6, 5, 2, 14, 7, 4, 4, "Coach",false, "IT");
let mother = new Queen("Mother Monster", 6, 5, 2, 14, 7, 4, 4, "Mother",false, "IT");
let trey = new Queen("Trey Angle", 4, 10, 2, 11, 13, 2, 4, "Trey",false, "IT");
let fire = new Queen("Fire Ma'aM", 10, 4, 11, 14, 2, 8, 4, "Fire",false, "IT");
let custom2 = [harmony, didi, devyn, cindy, millerd, cherri, surut, coach, mother, trey, fire, dahliam, mary];
//custom s3
let mike = new Queen("Mike Dragzowski", 1, 1, 1, 1, 1, 1, 4, "Mike",false, "IT");
let venusd = new Queen("Venus Galore", 11, 8, 12, 4, 5, 3, 4, "VenusG",false, "IT");
let terry = new Queen("Terry The Tuck", 1, 1, 1, 1, 1, 1, 4, "Terry",false, "IT");
let jani = new Queen("Jan II", 3, 2, 3, 11, 12, 7, 4, "JanI",false, "IT");
let heidig = new Queen("Heidi Good", 12, 10, 12, 5, 3, 2, 4, "HeidiG",false, "IT");
let betha = new Queen("Beth Amphetamine", 6, 5, 2, 14, 7, 4, 4, "BethA",false, "IT");
let caira = new Queen("Caira Cosplay", 6, 14, 4, 3, 11, 9, 4, "Caira",false, "IT");
let ayehsa = new Queen("Ayesha Apocalypse", 7, 7, 7, 11, 7, 7, 4, "Ayesha",false, "IT");
let bethl = new Queen("Beth Lahem", 1, 1, 1, 1, 1, 1, 4, "BethL",false, "IT");
...
//custom s4
let jenner = new Queen("Jenner Myles", 1, 1, 1, 1, 1, 1, 4, "Jenner",false, "IT");
let gusha = new Queen("Gusha", 2, 5, 3, 12, 10, 15, 4, "Gusha",false, "IT");
let evea = new Queen("Eve Angelica", 11, 3, 4, 13, 2, 15, 4, "EveA",false, "IT");
let taba = new Queen("Taba Co", 15, 12, 13, 4, 3, 2, 4, "Taba",false, "IT");
let amethyst = new Queen("Amethyst Rock Bottom", 13, 12, 4, 14, 2, 3, 4, "Amethyst",false, "IT");
let fet = new Queen("Fet Anyal", 2, 4, 15, 13, 12, 3, 4, "Fet",false, "IT");
let fairy = new Queen("Fairy Dust", 3, 4, 15, 12, 2, 13, 4, "Fairy",false, "IT");
let yurin = new Queen("Yurin D. Nile", 4, 15, 10, 3, 2, 11, 4, "Yurin",false, "IT");
let virgin = new Queen("Virgin Mary", 15, 13, 12, 4, 3, 2, 4, "Virgin",false, "IT");
let honeym = new Queen("Honey Mustard", 11, 15, 4, 13, 2, 3, 4, "Honeym",false, "IT");
let custom4 = [jenner, gusha, evea, taba, amethyst, fet, fairy, yurin, virgin, honeym];
//custom s5
let sapphire = new Queen("Sapphire Rock Bottom", 4, 12, 13, 14, 3, 2, 4, "Sapphire",false, "IT");
let angel = new Queen("Angel Azul", 11, 2, 13, 12, 4, 3, 4, "Angel",false, "IT");
let gem = new Queen("Gem", 2, 3, 12, 13, 4, 14, 4, "Gem",false, "IT");
let zombira = new Queen("Zombira", 10, 12, 2, 3, 4, 14, 4, "Zombira",false, "IT");
let canna = new Queen("Canna Biss", 1, 1, 4, 1, 2, 3, 4, "Canna",false, "IT");
...
let judgess = [brooke, rupaul, michelle, pangina, fred, priscilla, supremme, arta, nicky, jiggly];
let ultimate = [];
...
alyssa]
//judges
let kellyh = new Queen("Kelly Hyland", 3, 2, 7, 3, 2, 7, 1, "Kelly",false, "S");
let jojos = new Queen("Jojo Siwa", 3, 2, 7, 3, 2, 7, 1, "Jojos",false, "S");
let kimk = new Queen("Kim Kardashian", 3, 2, 7, 3, 2, 7, 1, "KimK",false, "S");
let sabrina = new Queen("Sabrina Carpenter", 3, 2, 7, 3, 2, 7, 1, "Sabrina",false, "S");
let britney = new Queen("Britney Spears", 3, 2, 7, 3, 2, 7, 1, "Britney",false, "S");
let melanie = new Queen("Melanie Martinez", 3, 2, 7, 3, 2, 7, 1, "Melanie",false, "S");
let dove = new Queen("Dove Cameron", 3, 2, 7, 3, 2, 7, 1, "Dove",false, "S");
let katyp = new Queen("Katy Perry", 3, 2, 7, 3, 2, 7, 1, "KatyP",false, "S");
let emily = new Queen("Emily Alyn Lind", 3, 2, 7, 3, 2, 7, 1, "Emily",false, "S");
let oliviar = new Queen("Olivia Rodrigo", 3, 2, 7, 3, 2, 7, 1, "OliviaR",false, "S");
...
let allQueens = [
    ...
    alexis, carmen, delta, india, manila, mariah, phoenix, raja, stacey, venus, yara,
    ...
    ginger, jaidynn, jasmine, kandy, katya, kennedy, max, fame, kasha, pearl, sashab, tempest, violet,
